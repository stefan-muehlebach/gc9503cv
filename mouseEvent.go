...
// Profil aufweisen.
type CallbackType func(evt Event)
...
// aufruft.
func (m *CallbackEmbed) OnInputEvent(evt Event) {
	m.CallPointFunc(evt)
}
...
func (m *CallbackEmbed) CallPointFunc(evt Event) {
...
func (m *CallbackEmbed) SetCallback(fnc CallbackType, types ...Type) {
